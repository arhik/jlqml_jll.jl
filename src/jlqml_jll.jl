...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import jlqml_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6b5019fb-a83d-5b4e-a9f7-678a36c28df7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "jlqml", artifacts_toml) for e in artifacts["jlqml"]]
...
if best_platform === nothing
    @debug("Unable to load jlqml; unsupported platform $(triplet(platform_key_abi()))")
else
